...
using MelonLoader;
using System.IO;
[assembly: MelonInfo(typeof(BTD6_Boom_Sentry_In_Shop.Class1), "Boom Sentry In Shop", "1.4.0", "kenx00x")]
[assembly: MelonGame("Ninja Kiwi", "BloonsTD6")]
namespace BTD6_Boom_Sentry_In_Shop
{
    public class Class1 : MelonMod
    {
        public static string dir = $"{Directory.GetCurrentDirectory()}\\Mods\\BoomSentryInShop";
        public static string config = $"{dir}\\config.txt";
        public static int SentryBoomCost = 500;
        public override void OnApplicationStart()
        {
            MelonLogger.Msg("Boom Sentry In Shop mod loaded");
            ...
            if (File.Exists(config))
            {
                ...
                using (StreamReader sr = File.OpenText(config))
                {
                    ...
                    {
                        SentryBoomCost = int.Parse(s.Substring(s.IndexOf(char.Parse("=")) + 1));
                    }
                }
            ...
            else
            {
                ...
                {
                    sw.WriteLine("BoomSentryCost=500");
                }
        ...
        public class ProfileModel_Patch
        {
            ...
            public static void Postfix(ProfileModel __instance)
            {
                ...
                if (unlockedTowers.Contains("SentryBoom"))
                {
                    MelonLogger.Msg("Boom Sentry already unlocked");
                }
                else
                {
                    MelonLogger.Msg("unlocking Boom Sentry");
                    unlockedTowers.Add("SentryBoom");
                }
            }
        }
        ...
        public class TitleScreen_Patch
        {
            ...
            {
                TowerModel towerModel = Game.instance.model.GetTowerWithName("SentryBoom");
                if (towerModel.icon == null)
                {
                    towerModel.icon = towerModel.portrait;
                }
                towerModel.cost = SentryBoomCost;
        ...
        public class TowerInventory_Patch
        {
            ...
            {
                ShopTowerDetailsModel towerDetails = new ShopTowerDetailsModel("SentryBoom", 1, 0, 0, 0, -1, 0, null);
        ...
        public class UpgradeScreen_Patch
        {
            ...
            {
                if (towerId.Contains("SentryBoom"))
                {
                    towerId = "DartMonkey";
                }
                return true;
