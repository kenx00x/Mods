...
{
    public class ParagonPowerTotem : ModTower
    {
		...
		public override string BaseTower => "ParagonPowerTotemTower";
        public override int Cost => Main.ParagonPowerTotem;
        public override int TopPathUpgrades => 0;
        public override int MiddlePathUpgrades => 0;
        public override int BottomPathUpgrades => 0;
        public override string Description => "Paragon Power Totem";
